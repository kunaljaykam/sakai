...
public interface LTIService extends LTISubstitutionsFilter {
    ...
    String[] TOOL_MODEL = {
            ...
            "lti13_tool_keyset:text:label=bl_lti13_tool_keyset:maxlength=1024:role=admin:archive=true",  // From the tool - keep legacy field name
            "lti13_oidc_endpoint:text:label=bl_lti13_oidc_endpoint:maxlength=1024:role=admin:archive=true",  // From the tool - keep legacy field name
            "lti13_oidc_redirect:text:label=bl_lti13_oidc_redirect:maxlength=1024:role=admin:archive=true",  // From the tool - keep legacy field name
