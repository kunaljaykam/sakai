...
public class GbGradeTable extends Panel implements IHeaderContributor {
	...
	public void renderHead(final IHeaderResponse response) {
		...
		response.render(
				JavaScriptHeaderItem.forUrl(String.format("/gradebookng-tool/webjars/tabulator-tables/6.2.0/dist/js/tabulator.min.js%s", version)));
		response.render(CssHeaderItem.forUrl(String.format("/gradebookng-tool/webjars/tabulator-tables/6.2.0/dist/css/tabulator.min.css%s", version)));
		...
		// 	"var tableDataTabulator = %s; GbGradeTable.renderTabulatorTable('%s', tableDataTabulator);",
