...
// //           field: "studentName",
// //           // we need custom data properties to be passed to the template
// //           _data_: GbGradeTable.student,
// //           formatter: GbGradeTable.studentCellRenderer,
// //           editor: false,
// //           width: 220,
// //       },
...
// //   // }
// //   const allColumns = GbGradeTable.tbrFixedColumns;
...
// GbGradeTable.tbrFixedColumns.forEach((colDef, index) => {
//     const th = document.createElement('th');
//     th.style.width = colDef.width + 'px';
//     th.innerHTML = customTitleFormatter(index, colDef.titleFormatter)(colDef._data_);
...
//     GbGradeTable.tbrFixedColumns.forEach(colDef => {
//         const td = document.createElement('td');
//         let cellValue = rowData[colDef.field];

//         if (colDef.formatter) {
//             cellValue = colDef.formatter({ getValue: () => rowData[colDef.field] }, {}, () => { });
//         }
...
//     return GbGradeTable.headerRenderer(col, data);
// };
// }
